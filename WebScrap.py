...
for i in range(1, len(options)):
  MainFun(options[i], "1/1/2018", datetime.date.today().strftime('%d/%m/%Y'))
...
df_all['Session'] = pd.to_datetime(df_all['Session'],errors='coerce')
df_all['Session'] = df_all['Session'].dt.strftime('%Y-%m-%d')
